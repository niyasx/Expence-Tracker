...
class Income extends StatelessWidget {
  ...
  Income({super.key, required this.mainBoard});

  final myController = TextEditingController();

//this function is used to convert the string input(textfield input) to an integer so we can use it to add or substract
  void myIncome() {
    final incomevalue = myController.text;
    int finalIncomeValue = int.parse(incomevalue);
    mainBoard.incomecarrier(finalIncomeValue);
    myController.clear();
  }

  // List of items in first dropdown menu
  final defualt = '';
  ...
  // List of items in second dropdown menu
  final payment = [
    'Gpay',
    'PhonePay',
    'Paypal',
  ...
  // List of items in third dropdown menu
  final attachments = [
    'Photo',
    'Video',
    'Audio',
                  ...
                  children: [
                    Padding(
                      ...
                      child: DropdownButtonFormField(
                          ...
                          items: category.map((categoryvalue) {
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField(
                          ...
                          items: payment.map((String walletitem) {
                            return DropdownMenuItem(
                              value: walletitem,
                              child: Text(walletitem),
                            );
                          }).toList(),
                          onChanged: (walletitem) {
                            Provider.of<IncomeProvider>(context)
                                .paymentpro(walletitem!);
                          }),
                    ),
                    Padding(
                      padding:
                      ...
                      child: DottedBorder(
                        ...
                        child: DropdownButtonFormField(
                            ...
                            items: attachments.map((String attachitem) {
                              return DropdownMenuItem(
                                value: attachitem,
                    ...
                    Stack(
                      children: [
                        ...
                        Positioned(
                            ...
                            top: 50,
                            child: FlutterSwitch(
                              value: Provider.of<IncomeProvider>(context)
                                  .isSwitched,
                              width: 46,
                              height: 24,
                              toggleSize: 24.0,
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                              ...
                              onPressed: () async {
                                ...
                                // RecentTransaction(mainBoard: widget.mainBoard);
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
